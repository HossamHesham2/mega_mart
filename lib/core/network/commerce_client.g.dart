...
class _CommerceClient implements CommerceClient {
  ...
  @override
  Future<ProductDetailsWrapper> getProductsDetails(String productId) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<ProductDetailsWrapper>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'products/${productId}',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ProductDetailsWrapper _value;
    try {
      _value = ProductDetailsWrapper.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  @override
  Future<BrandsResponseModel> getAllBrands() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<BrandsResponseModel>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'brands',
  ...
  @override
  Future<CartResponseModel> addToCart(CartRequest request, String token) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
